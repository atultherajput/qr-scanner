...
d.scanImage=function(a,b,c,e,f,g){b=void 0===b?null:b;c=void 0===c?null:c;e=void 0===e?null:e;f=void 0===f?!1:f;g=void 0===g?!1:g;var k=!1,h=new Promise(function(g,h){c||(c=new Worker(d.WORKER_PATH),k=!0,c.postMessage({type:"inversionMode",data:"both"}));var m=function(a){"qrResult"===a.data.type&&(c.removeEventListener("message",m),c.removeEventListener("error",l),clearTimeout(n),null!==a.data.data?g(a.data.data):h("QR code not found."))};var l=function(a){c.removeEventListener("message",m);c.removeEventListener("error",
l);clearTimeout(n);h("Scanner error: "+(a?a.message||a:"Unknown Error"))};c.addEventListener("message",m);c.addEventListener("error",l);var n=setTimeout(function(){return l("timeout")},3E3);d._loadImage(a).then(function(a){a=d._getImageData(a,b,e,f);c.postMessage({type:"decode",data:a},[a.data.buffer])}).catch(l)});b&&g&&(h=h.catch(function(){return d.scanImage(a,null,c,e,f)}));return h=h.finally(function(){k&&c.postMessage({type:"close"})})};
d.prototype.setGrayscaleWeights=function(a,b,c,e){this._qrWorker.postMessage({type:"grayscaleWeights",data:{red:a,green:b,blue:c,useIntegerApproximation:void 0===e?!0:e}})};d.prototype.setInversionMode=function(a){this._qrWorker.postMessage({type:"inversionMode",data:a})};d.prototype._onCanPlay=function(){this._updateSourceRect();this.$video.play()};d.prototype._onPlay=function(){this._updateSourceRect();this._scanFrame()};
d.prototype._onVisibilityChange=function(){document.hidden?this.pause():this._active&&this.start()};d.prototype._updateSourceRect=function(){var a=Math.round(2/3*Math.min(this.$video.videoWidth,this.$video.videoHeight));this._sourceRect.width=this._sourceRect.height=a;this._sourceRect.x=(this.$video.videoWidth-a)/2;this._sourceRect.y=(this.$video.videoHeight-a)/2};
d.prototype._scanFrame=function(){var a=this;if(!this._active||this.$video.paused||this.$video.ended)return!1;requestAnimationFrame(function(){d.scanImage(a.$video,a._sourceRect,a._qrWorker,a.$canvas,!0).then(a._onDecode,function(b){a._active&&"QR code not found."!==b&&console.error(b)}).then(function(){return a._scanFrame()})})};
...
d._getImageData=function(a,b,c,e){b=void 0===b?null:b;e=void 0===e?!1:e;c=(void 0===c?null:c)||document.createElement("canvas");var f=b&&b.x?b.x:0,g=b&&b.y?b.y:0,k=b&&b.width?b.width:a.width||a.videoWidth;b=b&&b.height?b.height:a.height||a.videoHeight;e||c.width===k&&c.height===b||(c.width=k,c.height=b);e=c.getContext("2d",{alpha:!1});e.imageSmoothingEnabled=!1;e.drawImage(a,f,g,k,b,0,0,c.width,c.height);return e.getImageData(0,0,c.width,c.height)};
...
export default d;
//# sourceMappingURL=qr-scanner-es5.min.js.map
